...
class DateCell: UICollectionViewCell {
    ...
    override var isSelected: Bool {
        didSet {
            contentView.backgroundColor = isSelected ? UIColor(Resources.Colors.Back.IOSprimary)
                : UIColor(Resources.Colors.Back.primary)
            self.contentView.layer.borderWidth = isSelected ? 3 : 0
            self.contentView.layer.borderColor = isSelected ? CGColor(red: 0.560, green: 0.560, blue: 0.580, alpha: 1)
                : nil
        }
    }
}
